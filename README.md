...
<p align="center">
  <img src="./examples/video.gif" alt="Example GIF" style="display: inline-block; width: 50%;">
  <img src="./examples/plot.png" alt="Example of Voronoi vertices" style="display: inline-block; width: 40%;">
</p>
